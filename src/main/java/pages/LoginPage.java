...
public class LoginPage {
   ...
   private final By rememberCheckboxLocator = By.name("remember");
   ...
   public void clickOnRemember() {
       driver.findElement(rememberCheckboxLocator).click();
   }
...
//   public void login() {
//       enterEmailOfValidUser();
//       enterPasswordOfValidUser();
//       clickLoginButton();
//   }
